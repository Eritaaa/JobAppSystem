...
namespace JobAppSystem.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private Perdoruesi CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(Perdoruesi)}'. " +
                    $"Ensure that '{nameof(Perdoruesi)}' is not an abstract class and has a parameterless constructor, or alternatively " +
